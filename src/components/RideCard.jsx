            ...
            <div onClick={() => {navigate(`/ride-details/${ride._id}`); scrollTo(0, 0)}} className='group rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl cursor-pointer transition-all duration-500 bg-white border border-bordercolor/50 hover:border-primary/20'>
                <div className='relative h-52 overflow-hidden'>
                    ...
                    {ride.videoUrl && (
                        ...
                        >
                            <div className='bg-primary/90 backdrop-blur-md text-white p-3 rounded-full shadow-lg transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 flex items-center gap-2'>
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M8 5.147v14l11-7-11-7z" />
                                </svg>
                                <span className='text-[10px] font-black uppercase tracking-widest pr-2'>Watch Demo</span>
                            </div>
                        </div>
                    )}
